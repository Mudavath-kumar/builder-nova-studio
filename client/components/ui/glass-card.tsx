  ...
  "glass-card backdrop-blur-xl transition-all duration-500",
  {
    variants: {
      variant: {
        ...
        cyber: "bg-gradient-to-br from-cyber-green/20 to-neon-blue/5 border-cyber-green/30",
        health: "bg-gradient-to-br from-health-red/10 to-success-green/5 border-health-red/20",
      },
      size: {
        sm: "p-4 rounded-2xl",
