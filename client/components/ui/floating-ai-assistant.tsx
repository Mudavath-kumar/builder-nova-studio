...
export const FloatingAIAssistant: React.FC<FloatingAIAssistantProps> = ({
  ...
  const handleMouseMove = (e: MouseEvent) => {
    ...
    const newY = Math.max(
      0,
      Math.min(window.innerHeight - 80, e.clientY - dragOffset.y),
    );
      ...
      {isOpen && !isMinimized && (
        <div
          ...
          style={{
            ...
            left:
              window.innerWidth - position.x < 400
                ? "auto"
                : `${position.x - 320}px`,
            bottom: window.innerHeight - position.y < 540 ? "24px" : "auto",
            top:
              window.innerHeight - position.y < 540
                ? "auto"
                : `${position.y - 460}px`,
          }}
        >
          <GlassCard
            variant="neon"
            size="lg"
            className="h-full flex flex-col animate-scale-in"
          >
            {/* Chat Header */}
      ...
      {isOpen && isMinimized && (
        <div
          ...
          style={{
            ...
            left:
              window.innerWidth - position.x < 300
                ? "auto"
                : `${position.x - 220}px`,
          }}
        >
          ...
          <div className="relative">
            {talkingAnimation ? (
              <div className="flex items-center justify-center">
                ...
                <div
                  className="w-3 h-3 bg-white rounded-full animate-bounce mx-1"
                  style={{ animationDelay: "0.1s" }}
                />
                <div
