...
export default function PrescriptionUpload() {
  const [scanMode, setScanMode] = useState<"camera" | "upload" | "gallery">(
    "camera",
  );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-accent/10">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div
          className="absolute w-64 h-64 bg-neon-gradient rounded-full opacity-10 blur-3xl animate-float bottom-20 left-20"
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm opacity-70">
                        Real-time prescription capture
                      </div>
                    </div>
                  </Button>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="font-semibold text-foreground">
                      Detected Medications ({selectedResult.pills.length})
                    </h3>
                            ...
                            {pill.sideEffects.length > 0 && (
                              <div className="p-3 bg-warning-orange/10 rounded-2xl border border-warning-orange/30">
                                <div className="flex items-center space-x-2 mb-2">
                                  ...
                                  <span className="text-sm font-medium text-warning-orange">
                                    Side Effects
                                  </span>
                                </div>
