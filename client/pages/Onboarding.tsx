  ...
  const slides: OnboardingSlide[] = [
    {
      ...
      description: "Experience the future of healthcare with our advanced AI assistant that provides instant health insights, personalized recommendations, and 24/7 medical support.",
      features: [
    ...
    },
    {
      ...
      description: "Our advanced neural networks analyze your symptoms in real-time, providing accurate health assessments with 98.7% precision. Get instant medical insights anytime, anywhere.",
      features: [
    ...
    },
    {
      ...
      description: "Simply scan your prescriptions with our intelligent OCR technology. We'll digitize your medications, set up reminders, and check for dangerous interactions automatically.",
      features: [
    ...
    },
    {
      ...
      description: "One-tap emergency protocols with GPS location sharing and automated medical facility contact. Access step-by-step first aid instructions for critical situations.",
      features: [
    ...
    },
    {
      ...
      description: "Talk naturally to your AI health assistant. Our advanced voice recognition understands medical terminology and provides spoken responses for accessible healthcare.",
      features: [
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-xs text-foreground/60">Getting Started</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <GlassCard variant="primary" size="sm" className="px-4 py-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium">Setup: {Math.round(((currentSlide + 1) / slides.length) * 100)}%</span>
                </div>
              </GlassCard>
      ...
      <div className="relative z-10 container mx-auto px-6 py-16">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-8 fade-in">
              <div className="space-y-6">
                <div className="inline-flex items-center space-x-2 glass-card p-3">
                  ...
                  <span className="text-sm font-medium">Step {currentSlide + 1}</span>
                </div>
                
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  <span className="text-foreground">{currentSlideData.title}</span>
                  <br />
              ...
              <div className="flex items-center space-x-4 pt-8">
                ...
                {currentSlide < slides.length - 1 ? (
                  <Button
                    onClick={nextSlide}
                    className="button-health flex-1"
                  >
                    Continue
                ...
                <div className="aspect-square bg-gradient-to-br from-neon-blue/20 via-deep-purple/20 to-cyber-green/20 rounded-3xl relative flex items-center justify-center">
                  ...
                  {currentSlide === 1 && (
                    <>
                      ...
                      <div className="absolute top-20 right-16 animate-bounce" style={{ animationDelay: '0.3s' }}>
                        <div className="w-3 h-3 bg-warning-orange rounded-full animate-pulse" />
                      </div>
                      <div className="absolute bottom-16 left-16 animate-bounce" style={{ animationDelay: '0.6s' }}>
                        <div className="w-5 h-5 bg-cyber-green rounded-full animate-pulse" />
                      </div>
                      <div className="absolute bottom-12 right-12 animate-bounce" style={{ animationDelay: '0.9s' }}>
                  ...
                  {currentSlide === 3 && (
                    <>
                      <div className="absolute top-10 left-10">
                        <GlassCard variant="health" size="sm" className="bg-health-red/20">
                  ...
                  {currentSlide === 4 && (
                    <>
                      ...
                      <div className="absolute top-3/4 right-1/4 w-4 h-4 bg-cyber-green rounded-full animate-ping" style={{ animationDelay: '0.5s' }} />
                      <div className="absolute bottom-1/4 left-3/4 w-3 h-3 bg-warning-orange rounded-full animate-ping" style={{ animationDelay: '1s' }} />
          ...
          <div className="flex justify-center mt-16">
            <GlassCard variant="default" size="sm" className="px-6 py-3">
              <label className="flex items-center space-x-3 cursor-pointer">
                ...
                />
                <span className="text-sm text-foreground/70">Auto-play slides</span>
          ...
          <div className="grid grid-cols-4 gap-6 mt-16">
            <GlassCard variant="primary" size="sm" hover="lift" className="text-center">
            ...
            <GlassCard variant="cyber" size="sm" hover="lift" className="text-center">
              <div className="space-y-2">
