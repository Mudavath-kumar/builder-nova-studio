  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-accent/10">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute w-64 h-64 bg-cyber-gradient rounded-full opacity-5 blur-3xl animate-float bottom-20 left-20" style={{ animationDelay: '2s' }} />
      </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/60">Your personal medical AI companion</p>
                </div>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-4 gap-8 h-full">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <GlassCard variant="primary" size="default" hover="lift">
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <h3 className="font-semibold text-foreground">Health Context</h3>
                </div>
                
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-foreground/70">Health Score</span>
                    <span className="text-sm font-semibold text-primary">85/100</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-foreground/70">Last Checkup</span>
                    <span className="text-sm font-semibold text-foreground">2 weeks ago</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-foreground/70">Medications</span>
                    <span className="text-sm font-semibold text-accent">2 active</span>
                  </div>
                </div>
              </div>
            </GlassCard>
            ...
            <GlassCard variant="neon" size="default" hover="lift">
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <h3 className="font-semibold text-foreground">Voice Features</h3>
                </div>
                
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-4 w-4 text-cyber-green" />
                    <span className="text-sm text-foreground/70">Real-time transcription</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-4 w-4 text-cyber-green" />
                    <span className="text-sm text-foreground/70">Medical terminology</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-4 w-4 text-cyber-green" />
                  ...
                  {!voiceAssistant.isSupported && (
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-warning-orange">Not supported in this browser</span>
                    </div>
                  )}
                </div>
              </div>
            ...
            <GlassCard variant="accent" size="default" hover="lift">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Button variant="ghost" size="sm" className="w-full justify-start glass-button">
                    Symptom Analysis
                  </Button>
                  <Button variant="ghost" size="sm" className="w-full justify-start glass-button">
                    Medication Check
            ...
            {lastTranscript && (
              <GlassCard variant="cyber" size="default">
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm text-foreground">Last Voice Input:</h4>
                  <p className="text-sm text-foreground/70 italic">"{lastTranscript}"</p>
                </div>
              </GlassCard>
            )}
          </div>
          ...
          <div className="lg:col-span-3">
            <GlassCard variant="default" size="lg" className="h-full">
              ...
              {voiceError && (
                <div className="mb-4">
                  <GlassCard variant="health" size="sm" className="bg-red-500/10 border-red-500/30">
                    <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-xs text-foreground/60">
                  {voiceAssistant.isListening ? "Tap to stop" : "Say 'Hey HealPulse'"}
                </div>
              </div>
            </div>
          </GlassCard>
