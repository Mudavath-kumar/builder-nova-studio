  ...
  const aiInsights = [
    {
      ...
      message:
        "You're doing great with water intake today! Try to reach 8 glasses for optimal hydration.",
      icon: Droplets,
      color: "text-neon-blue",
      priority: "low",
    },
    {
      ...
      message:
        "Don't forget to take your evening vitamin D supplement in 2 hours.",
      icon: Pill,
      color: "text-warning-orange",
      priority: "medium",
    },
    {
      ...
      message:
        "Your heart rate has been consistently healthy this week. Keep up the good work!",
      icon: TrendingUp,
                  ...
                  >
                    <div className="space-y-4">
                      <div className="flex justify-center">
                        ...
                        >
                          <metric.icon
                            className={cn("h-8 w-8", metric.color)}
                          />
                        </div>
                      </div>
                ...
                {aiInsights.map((insight) => (
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      ...
                      >
                        <insight.icon
                          className={cn("h-6 w-6", insight.color)}
                        />
                      </div>
              ...
              <GlassCard variant="primary" size="lg" className="text-center">
                <div className="space-y-6">
                  ...
                  <p className="text-sm text-foreground/70">
                    Your health score is updated in real-time based on your
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/70 mb-4">
                      I'm monitoring your health 24/7. Ask me anything about
                      your symptoms or wellness.
                    </p>
                  </div>
              ...
              <GlassCard variant="default" size="default">
                <div className="space-y-4">
                  {recentActivity.map((activity, index) => (
                    <div
                      key={index}
                      className="flex items-center space-x-4 p-3 bg-primary/5 rounded-2xl"
                    >
                ...
                <GlassCard variant="accent" size="sm">
                  ...
                  <div className="mt-2 bg-accent/20 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${Math.min(100, (stepsCount / 10000) * 100)}%`,
                      }}
                    />
                  </div>
                </GlassCard>
