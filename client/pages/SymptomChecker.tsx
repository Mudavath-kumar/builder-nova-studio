...
export default function SymptomChecker() {
  ...
  const [currentStep, setCurrentStep] = useState<'selection' | 'details' | 'analysis' | 'results'>('selection');

  const bodyParts: BodyPart[] = [
    { id: 'head', name: 'Head', position: { x: 50, y: 15 }, symptoms: ['headache', 'dizziness', 'fatigue'], isActive: false },
    { id: 'neck', name: 'Neck', position: { x: 50, y: 25 }, symptoms: ['neck pain', 'stiffness'], isActive: false },
    { id: 'chest', name: 'Chest', position: { x: 50, y: 40 }, symptoms: ['chest pain', 'shortness of breath'], isActive: false },
    { id: 'left-arm', name: 'Left Arm', position: { x: 25, y: 45 }, symptoms: ['arm pain', 'numbness'], isActive: false },
    { id: 'right-arm', name: 'Right Arm', position: { x: 75, y: 45 }, symptoms: ['arm pain', 'numbness'], isActive: false },
    { id: 'abdomen', name: 'Abdomen', position: { x: 50, y: 55 }, symptoms: ['stomach pain', 'nausea'], isActive: false },
    { id: 'left-leg', name: 'Left Leg', position: { x: 40, y: 80 }, symptoms: ['leg pain', 'swelling'], isActive: false },
    { id: 'right-leg', name: 'Right Leg', position: { x: 60, y: 80 }, symptoms: ['leg pain', 'swelling'], isActive: false },
  ];

  const commonSymptoms = [
    'Headache', 'Fever', 'Cough', 'Fatigue', 'Nausea', 'Dizziness',
    'Chest Pain', 'Shortness of Breath', 'Back Pain', 'Joint Pain',
    'Sore Throat', 'Runny Nose', 'Stomach Pain', 'Diarrhea',
    'Muscle Aches', 'Skin Rash', 'Sleep Issues', 'Anxiety'
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-accent/10">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute w-64 h-64 bg-health-gradient rounded-full opacity-5 blur-3xl animate-float bottom-20 left-20" style={{ animationDelay: '2s' }} />
      </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/60">Advanced medical AI analysis</p>
                </div>
              </div>
            </div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <GlassCard variant="primary" size="sm">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                {['selection', 'details', 'analysis', 'results'].map((step, index) => (
                  <div key={step} className="flex items-center space-x-2">
                    <div className={cn(
                      "w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300",
                      currentStep === step 
                        ? "bg-primary text-white animate-pulse" 
                        : index < ['selection', 'details', 'analysis', 'results'].indexOf(currentStep)
                    ...
                    <span className={cn(
                      ...
                      currentStep === step ? "text-primary" : "text-foreground/60"
                    )}>
                      {step}
                    </span>
                    {index < 3 && (
              ...
              <div className="space-y-4">
                ...
                <div className="relative aspect-[3/4] bg-gradient-to-b from-neon-blue/10 to-deep-purple/10 rounded-3xl border border-neon-blue/30">
                  <svg viewBox="0 0 100 100" className="w-full h-full">
                    {/* Body outline */}
                    <ellipse cx="50" cy="15" rx="8" ry="10" className="fill-primary/20 stroke-primary stroke-2" />
                    <rect x="45" y="25" width="10" height="15" className="fill-primary/20 stroke-primary stroke-2" rx="2" />
                    <rect x="43" y="40" width="14" height="20" className="fill-primary/20 stroke-primary stroke-2" rx="3" />
                    <rect x="20" y="35" width="8" height="20" className="fill-primary/20 stroke-primary stroke-2" rx="4" />
                    <rect x="72" y="35" width="8" height="20" className="fill-primary/20 stroke-primary stroke-2" rx="4" />
                    <rect x="46" y="60" width="8" height="15" className="fill-primary/20 stroke-primary stroke-2" rx="2" />
                    <rect x="38" y="75" width="8" height="20" className="fill-primary/20 stroke-primary stroke-2" rx="4" />
                    <rect x="54" y="75" width="8" height="20" className="fill-primary/20 stroke-primary stroke-2" rx="4" />
                      ...
                      <circle
                        ...
                        className={cn(
                          ...
                          selectedBodyPart === part.id
                            ...
                            : selectedSymptoms.some(s => s.bodyPart === part.id)
                    ...
                    <div className="absolute top-4 left-4 right-4">
                      <GlassCard variant="primary" size="sm">
                        <div className="text-center">
                          ...
                          <p className="text-xs text-foreground/60">Click to add symptoms</p>
                        </div>
                      </GlassCard>
                    </div>
                  )}
                    ...
                    {selectedSymptoms.map((symptom) => (
                      <GlassCard key={symptom.id} variant="primary" size="sm">
                        <div className="space-y-3">
                          ...
                          <div>
                            <label className="text-sm font-medium text-foreground/70">Severity</label>
                                ...
                                <Button
                                  ...
                                  className={cn(
                                    ...
                                    symptom.severity === severity && {
                                      ...
                                      moderate: 'bg-warning-orange text-white',
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70">
                      Our advanced AI is processing your symptoms using medical databases and machine learning algorithms...
                    </p>
                  </div>
                  
                  <div className="space-y-2">
                    <div className="text-sm text-foreground/60">Processing medical knowledge base...</div>
                    <div className="w-full bg-primary/20 rounded-full h-2">
                      <div className="bg-neon-gradient rounded-full h-2 animate-pulse" style={{ width: '100%' }} />
                    </div>
                  </div>
                </div>
              </GlassCard>
              ...
              <div className="space-y-4">
                ...
                {selectedSymptoms.length === 0 ? (
                  <div className="text-center py-8 text-foreground/50">
                    ...
                    <p className="text-sm">Click on the body map or search for symptoms</p>
                  </div>
                ) : (
                  <div className="space-y-3 max-h-64 overflow-y-auto custom-scrollbar">
                    {selectedSymptoms.map((symptom) => (
                      <div key={symptom.id} className="p-3 bg-primary/5 rounded-2xl border border-primary/20">
                        <div className="flex items-center justify-between">
                          <div>
                            <h4 className="font-medium text-foreground">{symptom.name}</h4>
                            <div className="flex items-center space-x-2 mt-1">
                              <span className={cn("text-xs font-medium", severityColors[symptom.severity])}>
                                {symptom.severity}
                              </span>
                              <span className="text-xs text-foreground/60">•</span>
                              <span className="text-xs text-foreground/60">{symptom.bodyPart}</span>
                            </div>
                          </div>
                          <Button
                            variant="ghost"
            ...
            {analysisResults.length > 0 && (
              <div className="space-y-4">
                ...
                {analysisResults.map((result, index) => (
                  <GlassCard key={index} variant="neon" size="default" hover="lift">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <h3 className="font-bold text-foreground">{result.condition}</h3>
                        <div className="flex items-center space-x-2">
                          <span className="text-2xl font-bold text-neon-blue">{result.probability}%</span>
                          <div className={cn("px-2 py-1 rounded-full text-xs font-medium", priorityColors[result.severity])}>
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-foreground text-sm mb-2">Next Steps:</h4>
                          <ul className="space-y-1">
                ...
                <GlassCard variant="health" size="sm" className="bg-health-red/10 border-health-red/30">
                  <div className="flex items-start space-x-3">
                    <AlertTriangle className="h-5 w-5 text-health-red mt-1" />
                    <div>
                      <p className="text-sm text-health-red font-medium">Medical Disclaimer</p>
                      <p className="text-xs text-health-red/80">
                        This AI analysis is for informational purposes only. Always consult with a healthcare professional for proper diagnosis and treatment.
                      </p>
                    </div>
                  </div>
                </GlassCard>
