...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-accent/10 overflow-hidden">
          ...
          <GlassCard variant="default" size="sm" className="mb-0">
            <nav className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center space-x-8">
                <a href="#features" className="text-foreground/70 hover:text-primary transition-all duration-300 hover:scale-105">Features</a>
                <a href="#ai-tech" className="text-foreground/70 hover:text-primary transition-all duration-300 hover:scale-105">AI Technology</a>
                <a href="#testimonials" className="text-foreground/70 hover:text-primary transition-all duration-300 hover:scale-105">Reviews</a>
                <a href="#contact" className="text-foreground/70 hover:text-primary transition-all duration-300 hover:scale-105">Contact</a>
              </div>
        ...
        >
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 slide-up">
              <div className="space-y-6">
                ...
                <p className="text-xl text-foreground/70 leading-relaxed max-w-lg">
                  ...
                  Get instant diagnosis, voice consultations, and personalized health insights 
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <Link to="/dashboard">
                  <Button size="lg" className="button-cyber text-black font-bold px-8 py-6 text-lg">
                ...
                <Link to="/ai-chat">
                  <Button variant="outline" size="lg" className="glass-button px-8 py-6 text-lg border-2 border-primary/30">
              ...
              <div className="flex items-center space-x-8 pt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm font-medium text-foreground/80">Free Forever Plan</span>
                </div>
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm font-medium text-foreground/80">AI Certified</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative float">
              <GlassCard variant="neon" size="xl" hover="glow" className="relative overflow-hidden">
                <div className="aspect-square bg-gradient-to-br from-neon-blue/20 via-deep-purple/20 to-cyber-green/20 rounded-3xl relative">
                  ...
                  <div className="absolute top-8 right-8 interactive-hover" style={{ animationDelay: '0.5s' }}>
                    <GlassCard variant="accent" size="sm">
                      <Camera className="h-8 w-8 text-accent animate-pulse" />
                    </GlassCard>
                  </div>
                  
                  <div className="absolute bottom-8 left-8 interactive-hover" style={{ animationDelay: '1s' }}>
                    <GlassCard variant="cyber" size="sm">
                      <Phone className="h-8 w-8 text-cyber-green animate-bounce" />
                    </GlassCard>
                  </div>
                  
                  <div className="absolute bottom-8 right-8 interactive-hover" style={{ animationDelay: '1.5s' }}>
                  ...
                  <div className="absolute inset-0">
                    <div className="absolute top-1/4 left-1/4 w-4 h-4 bg-neon-blue rounded-full animate-ping" style={{ animationDelay: '0s' }}></div>
                    <div className="absolute top-3/4 right-1/4 w-3 h-3 bg-cyber-green rounded-full animate-ping" style={{ animationDelay: '0.8s' }}></div>
                    <div className="absolute bottom-1/4 left-3/4 w-2 h-2 bg-deep-purple rounded-full animate-ping" style={{ animationDelay: '1.6s' }}></div>
                  </div>
                </div>
                
                {/* Real-time Metrics Overlay */}
                <div className="absolute -top-4 -right-4">
                  <GlassCard variant="primary" size="sm" className="bg-success-green/20">
                    <div className="flex items-center space-x-2">
                      <TrendingUp className="h-4 w-4 text-success-green" />
                      <span className="text-sm font-bold text-success-green">98.7% Accuracy</span>
                    </div>
                  </GlassCard>
                </div>
                
                <div className="absolute -bottom-4 -left-4">
                  <GlassCard variant="neon" size="sm" className="bg-neon-blue/20">
                    <div className="flex items-center space-x-2">
                      <Globe className="h-4 w-4 text-neon-blue animate-spin-slow" />
                      <span className="text-sm font-bold text-neon-blue">24/7 Available</span>
                    </div>
                  </GlassCard>
                </div>
              </GlassCard>
      ...
      <section id="features" className="relative container mx-auto px-6 py-32">
        <div className="text-center space-y-6 mb-20 fade-in">
          <div className="inline-flex items-center space-x-2 glass-card p-3">
            ...
            <span className="text-sm font-medium">Revolutionary Healthcare Features</span>
          </div>
          ...
          <p className="text-xl text-foreground/70 max-w-3xl mx-auto">
            Discover powerful AI-driven features designed to revolutionize your healthcare experience
          </p>
        </div>
        
        <div className="grid lg:grid-cols-3 gap-8">
          {/* AI Symptom Analysis */}
          <GlassCard variant="primary" size="lg" hover="intense" className="card-interactive">
            <div className="space-y-6">
              <div className="relative">
              ...
              <div className="text-center space-y-4">
                <h3 className="text-2xl font-bold text-foreground">AI Symptom Analysis</h3>
                <p className="text-foreground/70">
                  Advanced neural networks analyze your symptoms in real-time, providing 
                  instant diagnosis suggestions with 98.7% accuracy rate.
                </p>
          ...
          {/* Voice Assistant */}
          <GlassCard variant="neon" size="lg" hover="intense" className="card-interactive">
            <div className="space-y-6">
              <div className="relative">
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-foreground/70">
                  ...
                  Natural language processing understands medical terminology perfectly.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center space-x-2 text-sm text-foreground/60">
          ...
          {/* Emergency Response */}
          <GlassCard variant="health" size="lg" hover="intense" className="card-interactive">
            <div className="space-y-6">
              <div className="relative">
              ...
              <div className="text-center space-y-4">
                <h3 className="text-2xl font-bold text-foreground">Emergency Response</h3>
                <p className="text-foreground/70">
      ...
      <section id="ai-tech" className="relative py-32 bg-gradient-to-r from-primary/5 to-accent/5">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-foreground/70">
                  Our proprietary AI models are trained on millions of medical cases, 
                  providing healthcare insights that rival human specialists.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <GlassCard variant="primary" size="sm" hover="lift">
                  <div className="text-center space-y-2">
                    ...
                    <div className="text-sm text-foreground/60">Diagnosis Accuracy</div>
                  </div>
                </GlassCard>
                ...
                <GlassCard variant="cyber" size="sm" hover="lift">
                  <div className="text-center space-y-2">
                    <div className="text-3xl font-bold text-cyber-green">50M+</div>
                    <div className="text-sm text-foreground/60">Medical Cases</div>
                  </div>
                </GlassCard>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="space-y-6">
            <div className="inline-flex items-center space-x-2 glass-card p-3">
              ...
              <span className="text-sm font-medium">Join the Health Revolution</span>
            </div>
            <h2 className="text-5xl font-bold">
            ...
            <p className="text-xl text-foreground/70 max-w-2xl mx-auto">
              Join thousands of users who trust HealPulse for their healthcare needs. 
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link to="/signup">
              <Button size="lg" className="button-cyber text-black font-bold px-12 py-6 text-xl">
            ...
            <Link to="/ai-chat">
              <Button variant="outline" size="lg" className="glass-button px-12 py-6 text-xl border-2 border-primary/30">
          ...
          <div className="grid md:grid-cols-4 gap-12">
            <div className="space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-foreground/60">AI Health Revolution</div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <a href="#" className="block text-foreground/70 hover:text-primary transition-colors hover:translate-x-1">AI Symptom Checker</a>
                <a href="#" className="block text-foreground/70 hover:text-primary transition-colors hover:translate-x-1">Voice Assistant</a>
                <a href="#" className="block text-foreground/70 hover:text-primary transition-colors hover:translate-x-1">Emergency Response</a>
                <a href="#" className="block text-foreground/70 hover:text-primary transition-colors hover:translate-x-1">Health Records</a>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <a href="#" className="block text-foreground/70 hover:text-primary transition-colors hover:translate-x-1">About Us</a>
                <a href="#" className="block text-foreground/70 hover:text-primary transition-colors hover:translate-x-1">Careers</a>
                <a href="#" className="block text-foreground/70 hover:text-primary transition-colors hover:translate-x-1">Press</a>
                <a href="#" className="block text-foreground/70 hover:text-primary transition-colors hover:translate-x-1">Blog</a>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <a href="#" className="block text-foreground/70 hover:text-primary transition-colors hover:translate-x-1">Help Center</a>
                <a href="#" className="block text-foreground/70 hover:text-primary transition-colors hover:translate-x-1">Privacy Policy</a>
                <a href="#" className="block text-foreground/70 hover:text-primary transition-colors hover:translate-x-1">Terms of Service</a>
                <a href="#" className="block text-foreground/70 hover:text-primary transition-colors hover:translate-x-1">HIPAA Compliance</a>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-border/50 mt-16 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-foreground/60 text-center md:text-left">
                &copy; 2024 HealPulse. All rights reserved. Made with ❤️ for better healthcare.
              </p>
              <div className="flex items-center space-x-6">
                <span className="text-sm text-foreground/60">Powered by</span>
                <div className="flex items-center space-x-2">
                  <Bot className="h-4 w-4 text-neon-blue animate-pulse" />
                  <span className="text-sm font-medium text-neon-blue">Advanced AI</span>
                </div>
              </div>
            </div>
          </div>
