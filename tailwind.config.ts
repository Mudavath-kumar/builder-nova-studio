  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'neumorphic-hover': '12px 12px 20px rgba(0, 0, 0, 0.15), -12px -12px 20px rgba(255, 255, 255, 0.8)',
        'glass': '0 8px 32px 0 rgba(31, 38, 135, 0.37)',
        'glass-hover': '0 12px 40px 0 rgba(31, 38, 135, 0.5)',
        'neon': '0 0 20px rgba(0, 212, 255, 0.5), 0 0 40px rgba(0, 212, 255, 0.3)',
        'neon-purple': '0 0 20px rgba(139, 95, 191, 0.5), 0 0 40px rgba(139, 95, 191, 0.3)',
        'cyber': '0 0 30px rgba(57, 255, 20, 0.4), inset 0 0 30px rgba(57, 255, 20, 0.1)',
      ...
      keyframes: {
        ...
        glow: {
          ...
          '100%': { boxShadow: '0 0 40px rgba(135, 206, 235, 0.8), 0 0 60px rgba(135, 206, 235, 0.4)' },
        },
        shake: {
